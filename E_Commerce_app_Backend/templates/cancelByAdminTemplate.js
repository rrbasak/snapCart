const generateCancelByAdminEmailContent = (orderDetails) => {
  const {
    customerName,
    orderId,
    arrivalDate,
...
<div class="container">
    ...
    <p>We regret to inform you that your order <strong>#${orderId}</strong> has been cancelled by Snapcart.in.</p>
    <p><strong>Reason for cancellation:</strong> ${cancellationReason}</p>
    <div class="expected-delivery">
      <p><strong>Expected delivery:</strong> <span style="font-weight: bold;">${arrivalDate}</span></p>
      <p>This date is provided to give you an idea of when you could have expected your order to arrive.</p>
    </div>
...
export { generateCancelByAdminEmailContent };
