...
function Home() {
  ...
  const count = [
    ...
    // },
    {
      ...
      title: "45",
      persent: "Pending",
      icon: cart, // Replace with an appropriate icon
      bnb: "redtext",
    },
    // {
    //   today: "Active Delivery Personnel",
    //   title: "25",
    //   persent: "+5%",
    //   icon: cart, // Replace with a delivery-related icon
    //   bnb: "bnb2",
    // },
    {
      ...
      title: "1,450",
      persent: "+12%",
      icon: cart, // Replace with a product-related icon
      bnb: "bnb2",
    },
    {
      ...
      title: "8",
      persent: "Pending",
      icon: cart, // Replace with an icon for approvals or users
      bnb: "redtext",
    },
  ];
